...
$stmt = $pdo->prepare("INSERT INTO cap_chat_content(room_id, sender_id, message, thread_flg, thread_id, indate) VALUES(:room_id, :sender_id, :message, :thread_flg, :thread_id, sysdate())");
