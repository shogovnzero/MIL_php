...
$operator = $_SESSION["join"]["operator"];
...
$stmt = $pdo->prepare("UPDATE cap_vessel SET vessel_number=:vessel_number, vessel_name_jp=:vessel_name_jp, vessel_name_en=:vessel_name_en, manager=:manager, operator=:operator, vessel_reg_port=:vessel_reg_port, vessel_trade_pref=:vessel_trade_pref, vessel_trade_port=:vessel_trade_port,
 vessel_type=:vessel_type, vessel_gt=:vessel_gt, vessel_nt=:vessel_nt, vessel_dwt=:vessel_dwt, vessel_tank=:vessel_tank, vessel_teu=:vessel_teu, vessel_loa=:vessel_loa, vessel_beam=:vessel_beam, vessel_depth=:vessel_depth, vessel_draft=:vessel_draft, vessel_crew=:vessel_crew, 
 vessel_sy=:vessel_sy, vessel_built=:vessel_built, vessel_me=:vessel_me, vessel_fuel=:vessel_fuel WHERE vessel_id=:vessel_id");
